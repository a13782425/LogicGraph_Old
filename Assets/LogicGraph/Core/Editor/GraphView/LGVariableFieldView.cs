...
namespace Logic.Editor
{
    public sealed class LGVariableFieldView : BlackboardField
    {
        ...
        public LGVariableFieldView(BaseGraphView graphView, BaseVariable param) : base(null, param.Name, param.GetValueType().Name)
        {
            ...
            (this.Q("textField") as TextField).RegisterCallback<FocusOutEvent>((e) =>
            {
                ...
                {
                    BaseVariable variable = graphView.Target.Variables.FirstOrDefault(a => a.Name == text);
                ...
                this.owner.Event.OnEvent(LGEvent.VAR_MODDIFY, this.param);
            });
        }
