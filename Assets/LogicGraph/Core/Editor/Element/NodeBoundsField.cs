...
{
    public sealed class NodeBoundsField : BoundsField, INodeElement<Bounds>
    {
        ...
        public void Init(BaseNodeView nodeView, FieldInfo fieldInfo, string titleName)
        {
            ...
            this.value = (Bounds)fieldInfo.GetValue(nodeView.target);
            this.RegisterCallback<ChangeEvent<Bounds>>((e) => OnValueChange(e.newValue));
        }

        private void OnValueChange(Bounds newValue)
        {
